      ...
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/muhammadamir.faris/"
            ...
            <li>
              <a
                href="https://www.instagram.com/amirfaris._/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://twitter.com/amifaris1"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/muhammad-amir-faris-bin-rizman-8882662a5/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
