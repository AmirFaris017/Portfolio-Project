...
export default function Testimonials() {
    return (
        <section className="testimonial-section" id="Testimonials">
            <div className="portfolio--container-box"><div className="portfolio--container">
                <p className="sub--tile">Client Feedback</p>
                <h2 className="sections-heading">Customer Feedback</h2>
            </div>
            </div>
            <div className="portfolio--section--container">
                {data?.testimonials?.map((item, index) => (
                    <div key={index} className="testimonial--section--card"><div className="testimonial--section--card--review">
